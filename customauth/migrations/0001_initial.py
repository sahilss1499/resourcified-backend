    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[('student', 'student'), ('admin', 'admin')], max_length=50, null=True)),
                ...
                ('degree', models.CharField(blank=True, choices=[('btech', 'btech'), ('mtech', 'mtech'), ('phd', 'phd'), ('msc', 'msc'), ('mba', 'mba')], max_length=50, null=True)),
